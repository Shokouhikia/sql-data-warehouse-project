...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '>> Load Duration: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) /1000.0 AS NVARCHAR) + ' seconds';
        PRINT '>> -------------';
...
-- Calculate end date as one day before the next start date
        ...
        PRINT '   - Total Load Duration: ' + CAST(DATEDIFF(SECOND, @batch_start_time, @batch_end_time)/1000.0 AS NVARCHAR) +
              ' seconds';
        PRINT '=========================================='
